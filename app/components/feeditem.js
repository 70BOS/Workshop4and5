          ...
          <CommentThread onPost={(commentText) => this.handleCommentPost(commentText)}>
            {
              data.comments.map((comment, i) => {
                ...
                return (
                  <Comment key={i} author={comment.author} likeCounter={comment.likeCounter} postDate={comment.postDate} feedItem={this.state._id} index={i}>{comment.contents}</Comment>
                );
              })
            }
          </CommentThread>
